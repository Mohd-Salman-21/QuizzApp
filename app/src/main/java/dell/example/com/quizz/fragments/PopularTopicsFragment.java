...
import dell.example.com.quizz.TopicAdapter.TopicsAdapter;
...
public class PopularTopicsFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mRecyclerView=(RecyclerView)getView().findViewById(R.id.popularTopicsRecylerview);
       ...
       final      TopicsAdapter topicsAdapter=new TopicsAdapter(getContext(),arrayList);
        ...
        database.getReference("quizz").child("topics").addChildEventListener(new ChildEventListener() {
                @Override
